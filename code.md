  ...
  const features = [
    {
      ...
      description: "Content is fetched directly from Wikipedia's public API.",
      icon: <Zap className="size-5" />,
    },
    {
      title: "Swipe-Based Learning",
      description: "Vertical scrolling makes knowledge quick and digestible.",
      icon: <BarChart className="size-5" />,
    },
    {
      title: "Focused Reading",
      description: "No ads, no distractions — just information.",
      icon: <Users className="size-5" />,
    },
    {
      title: "Lightweight & Fast",
      description: "Optimized for performance and mobile-first usage.",
        ...
        <section className="w-full py-20 md:py-32 bg-muted/30 relative overflow-hidden">
          ...
          <div className="container px-4 md:px-6 relative">
            ...
            >
              ...
              <p className="max-w-[800px] text-muted-foreground md:text-lg">It's easy to get started with WikiSnap.</p>
            </motion.div>
              ...
              {[
                {
                  ...
                  description: "Select from a wide range of topics or search for what you're curious about.",
                },
                {
                  step: "02",
        ...
        <section id="faq" className="w-full py-20 md:py-32">
          <div className="container px-4 md:px-6">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight">What's Next?</h2>
